  ...
  return (
    <div className="w-full bg-white text-neutral-900">
      <div className="mx-auto max-w-2xl text-center">
        ...
        >
          High-quality essentials curated for everyday comfort and timeless style.
        </motion.p>
      ...
      <div className="mb-8 flex flex-col gap-4 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm md:flex-row md:items-center md:justify-between">
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 pl-10 pr-4 text-sm text-neutral-900 focus:border-green-600 focus:bg-white focus:outline-none"
          />
        </div>
        ...
        <select
          ...
          className="w-full rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm text-neutral-900 focus:border-green-600 focus:bg-white focus:outline-none md:w-52"
        >
          {CATEGORIES.map((cat) => (
      ...
      {noProductsAtAll ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-200 py-24 text-center bg-white">
      ...
      {!isLoading && limit && filteredProducts.length > limit && (
        <div className="mt-10 flex justify-center">
          <motion.button
            ...
            className="flex items-center gap-2 rounded-full bg-neutral-900 px-6 py-3 text-sm font-medium text-white shadow-sm transition-colors hover:bg-green-700 focus-visible:outline-none"
          >
