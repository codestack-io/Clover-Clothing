  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:shadow-md">
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-gray-100">
        ...
        {/* Wishlist Button: Appears on Hover at Top Right */}
        <button
          onClick={() => toggleWishlist(product)}
          className="absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-black/80 text-white opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100 hover:scale-110 active:scale-95"
        ...
        {/* View Details Button: Appears on Hover at Bottom Center */}
        <div className="absolute bottom-4 left-1/2 z-10 -translate-x-1/2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
